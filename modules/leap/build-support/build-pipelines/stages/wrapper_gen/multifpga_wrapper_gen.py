...
class WrapperGen():
  ...
  def __init__(self, moduleList):
    ...
    for module in topo:
      ...
      #ignore_bsv.write(moduleList.env['DEFS']['ROOT_DIR_HW'] + '/' + module.buildPath + '/' + module.name + "_Wrapper_con_size.bsh\n")
      #ignore_bsv.write(moduleList.env['DEFS']['ROOT_DIR_HW'] + '/' + module.buildPath + '/' + module.name + "_Wrapper.bo\n")
      ignore_bsv.close();
